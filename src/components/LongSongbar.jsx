...
export const LongSongbar = ({ song }) => {
  return (
    <div className="relative flex flex-row bg-[#1A1E1F] h-[56px] w-full rounded-[20px] items-center p-4 mx-auto mb-[10px]">
      <div className="flex ">
        <img
      ...
      <div className="flex items-center justify-between sm:px-8 py-6 w-full">
        ...
        <div className="sm:flex">
          <p className="text-xs text-[#ffffff]/50 sm:order-first">{"6:13"}</p>
          <button className="">
            <img
              src={More}
              alt="heart_icon"
